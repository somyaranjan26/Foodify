...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="foodify_logo.png">
...
<body>
        ...
        <head>
            ...
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <meta http-equiv="X-UA-Compatible" content="ie=edge">
            <link rel="shortcut icon" type="image/png" href="Images/foodify_logo.png">
        ...
        <body>
            <header class="header">
                <div class="logo-box">
                    <img src="foodify_logo.png" alt="Foodify Logo" class="logo">
                </div>
                <div class="text-area">
